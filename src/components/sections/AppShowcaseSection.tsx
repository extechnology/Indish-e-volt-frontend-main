...
const steps: Step[] = [
  {
    ...
    desc: 'Drive up to any Indish-e-Volt 160 kW station. Grab the liquid-cooled CCS2 handle, plug it into your EV, and the session starts in seconds — no app required.',
  ...
  },
  {
    ...
    title: 'Power up fast',
    desc: 'Your EV drinks up to 160 kW of clean solar power. Watch live kW rate, battery SoC %, and estimated range added — all on the station screen or our app.',

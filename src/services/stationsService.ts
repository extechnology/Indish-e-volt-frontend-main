...
const DUMMY_STATIONS: ChargingStation[] = [
  // Bengaluru Hubs
  {
    ...
    connectors: [
      { type: 'CCS2', power: 350, available: 4, total: 6 },
  ...
  },
  {
    ...
    connectors: [
      { type: 'CCS2', power: 350, available: 6, total: 10 },
  ...
  },
  {
    ...
    connectors: [{ type: 'CCS2', power: 350, available: 5, total: 6 }],
  ...
  // Mumbai & Navi Mumbai
  {
    ...
    connectors: [
      { type: 'CCS2', power: 350, available: 8, total: 12 },
  ...
  },
  {
    ...
    connectors: [
      { type: 'CCS2', power: 180, available: 4, total: 8 },
      { type: 'Type2', power: 22, available: 2, total: 4 },
    ],
  ...
  },
  {
    ...
    connectors: [
      { type: 'CCS2', power: 350, available: 7, total: 8 },
  ...
  // Ahmedabad & Gujarat
  {
    ...
    connectors: [{ type: 'CCS2', power: 350, available: 5, total: 8 }],
  ...
  },
  {
    ...
    connectors: [{ type: 'CCS2', power: 180, available: 3, total: 4 }],
    amenities: ['WiFi', 'Restrooms'],
  ...
  // Chennai
  {
    ...
    connectors: [{ type: 'CCS2', power: 350, available: 4, total: 8 }],
  ...
  // Kolkata
  {
    ...
    connectors: [{ type: 'CCS2', power: 180, available: 3, total: 6 }],
  ...
  // Chandigarh
  {
    ...
    connectors: [{ type: 'CCS2', power: 350, available: 4, total: 6 }],

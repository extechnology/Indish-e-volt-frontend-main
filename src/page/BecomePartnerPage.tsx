...
export default function BecomePartnerPage() {
  ...
  return (
    <div className="pt-28 pb-20 px-4 sm:px-8 max-w-4xl mx-auto space-y-12">
        ...
        <form onSubmit={handleSubmit} className="rounded-3xl bg-white p-8 sm:p-10 border border-slate-200 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <input
                type="email"
                required
                placeholder="sarah@commercial-property.com"
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 px-4 text-sm focus:border-[#00D66C] focus:bg-white focus:outline-none"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <select className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 px-4 text-sm focus:border-[#00D66C] focus:bg-white focus:outline-none">
                <option>Retail Shopping Center / Mall</option>
          ...
          <div>
            ...
            <input
              type="text"
              required
              placeholder="100 Tech Parkway, Austin, TX"
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 px-4 text-sm focus:border-[#00D66C] focus:bg-white focus:outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-2 py-4 rounded-2xl bg-[#00D66C] text-slate-950 font-black text-sm hover:bg-[#00C060] hover:shadow-lg transition-all"
          >
